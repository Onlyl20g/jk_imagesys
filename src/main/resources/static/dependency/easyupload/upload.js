        ...
        this.each(function (index, element) {
            ...
            var easyManager = {
                init: function () {
                    ...
                    $html += '<span class="easy_upload_select noselect mdui-color-blue">' + option.selectText + '</span>';
                    $html += '<span class="easy_upload_head_btn1 noselect mdui-color-blue">上传</span>';
                ...
                _renderFile: function (fileArr, target) {
                    ...
                    function render(file) {
                        ...
                        if (fileNames.indexOf(file.file.name) == 0) {
                            return;
                        }
                            ...
                            success: function (data) {
                                if (data.result > 0) {
                                    ...
                                    if (fileType == 'bmp' || fileType == 'jpg' || fileType == 'jpeg' || fileType == 'png' || fileType == 'gif') {
                                        ...
                                        preview = '<i style="width: 100px;height: 90px" class="easy_upload_icon easyUploadIcon">&#xe69d;</i>';
                                    } else {
                                        preview = '<i style="width: 100px;height: 90px" class="easy_upload_icon easyUploadIcon">&#xe64d;</i>';
                                    }
                                    var sHtml = '';
                                    ...
                                    $html += '<p class="easy_upload_filename clean_class">' + f.name + '</p>';
                                    ...
                                    $html += '</div>';
                                    $html += '<div class="easy_upload_status queue_item-section">';
                                    $html += '<span style="margin-left: 10px;"><input  readonly="readonly" class="layui-layer-wrap" style="width: 120px;height: 30px;border:0;" type="text" id="folderName" value="' + "" + '" /><input class="folderId" style="display: none" type="text"  value="' + sessionStorage.getItem("code") + '" /></span>';
                                    ...
                                    $html += '<p class="easy_upload_delbtn btn noselect mdui-color-orange">删除</p>';
                                    $html += '</div>';
                                    ...
                                    // layer.msg("已存在重名文件,请重选择");
                                    fileNames.remove(file.file.name);
                                    layer.open({
                                        title: "提示",
