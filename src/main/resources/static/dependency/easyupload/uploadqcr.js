        ...
        this.each(function (index, element) {
            ...
            var easyManager = {
                init: function () {
                    ...
                    $html += '<span class="easy_upload_head_btn1 noselect mdui-color-blue" style="display: none;">上传</span>';
                    // $html += '<span class="easy_upload_head_btn2 noselect mdui-color-blue">删除</span>';
