package com.jinke.framework.shiro.service;
...
import com.jinke.common.utils.MessageUtils;
import com.jinke.common.utils.ServletUtils;
import com.jinke.common.utils.security.ShiroUtils;
import com.jinke.framework.manager.AsyncManager;
import com.jinke.framework.manager.factory.AsyncFactory;
import com.jinke.project.system.user.domain.User;
import com.jinke.project.system.user.domain.UserStatus;
...
public class LoginService {
     ...
     * 通过SSO登录
     */
    public User loginSso(String username) {
        // 用户名或密码为空 错误
        ...
        AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, Constants.LOGIN_SUCCESS, MessageUtils.message("user.login.sso.success")));
        recordLoginInfo(user);
        return user;
    }
