package com.jinke.project.tool.gen.controller;
...
import com.jinke.project.tool.gen.service.IGenService;
...
public class GenController extends BaseController {
    ...
    public void genCode(HttpServletResponse response, @PathVariable("tableName") String tableName) throws IOException {
        ...
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"jinke.zip\"");
